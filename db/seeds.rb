...
Project.create(user_id: 1, working_title: "Kian and the Twin Blades", status: "in progress")

Project.create(user_id: 1, working_title: "Dawn Hollow Academy, semester 1", status: "in progress")
